        ...
        <div className='py-16 bg-gray-100 dark:bg-gray-950'>
            ...
            <div className='relative px-6 max-w-4xl mx-auto'>
                ...
                {experiences.map((item, index) => {
                    return <div
                        ...
                        key={index} className={`relative flex flex-col md:flex-row gap-8 mb-12 ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}>
                        {/*timeline node*/}
            ...
            bg-white border-2 border-blue-500 flex items-center justify-center z-10'>
                        ...
                        <div className='ml-16 md:ml-0 md:w-[calc(50%-2rem)]'>
                            <div className='bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 hover:scale-105 transition-all duration-100'>
                                ...
                                <div className='flex flex-wrap gap-2'>
                                    {item.technologies.map((tech) => {
                                        return <span key={tech} className='text-xs px-2 py-1 rounded-md bg-indigo-500 text-white'>
                                            {tech}
                                        </span>
                                    })}
                                </div>
