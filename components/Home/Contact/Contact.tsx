            ...
            <form className='bg-white dark:bg-gray-800 rounded-2xl p-8 space-y-6'>
              <div className='grid sm:grid-cols-2 gap-4'>
                <div className='space-y-2'>
                  <label htmlFor="name" className='text-sm font-meduim'>Name</label>
                  <Input id="name" name="name" placeholder='Jhon doe' required className='bg:gray-100' />
                </div>
                <div className='space-y-2'>
                  <label htmlFor="email" className='text-sm font-meduim'>Email</label>
                  <Input id="email" name="email" placeholder='jhondoe@gmail.com' required className='bg:gray-100' />
                </div>
              </div>
              <div className='space-y-2'>
                <label htmlFor="subject" className='text-sm font-meduim'>Subject</label>
                <Input id="subject" name="subject" placeholder='Project Inquiry' required className='bg-gray-100' />
              </div>
              <div className='space-y-2'>
                <label htmlFor="Message" className='text-sm font-meduim'>Message</label>
